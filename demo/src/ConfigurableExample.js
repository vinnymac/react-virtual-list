  ...
  return class MyConfigurableList extends PureComponent {
    ...
    update() {
      ...
      const state = {
        ...
        scrollDelay: parseInt(this.refs.scrollDelay.value, 10),
        itemBuffer: parseInt(this.refs.itemBuffer.value, 10),
      };

      if (state.scrollDelay !== this.state.scrollDelay || state.contained !== this.state.contained) {
        const options = {
          scrollDelay: state.scrollDelay,
        ...
        <div>
          <div role="form" className="form-horizontal">
            ...
            <div className="form-group">
              ...
              <div className="col-xs-6 col-sm-4">
                <input onChange={this.update} className="form-control" type="number" min="-1" value={this.state.scrollDelay} id="scrollDelay" ref="scrollDelay" />
              </div>
            </div>
          </div>
          <div className="row">
